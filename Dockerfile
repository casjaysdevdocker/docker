...
ARG BUILD_DATE="Fri Sep  1 12:32:35 PM EDT 2023"
...
ARG SERVICE_PORT="2375"
ARG EXPOSE_PORTS="2375"
...
ARG PACK_LIST="alpine-sdk fuse-overlayfs docker dockerize docker-cli docker-engine docker-cli-buildx docker-cli-compose docker-cli-buildx"
...
ENV HOSTNAME="casjaysdev-docker"
...
RUN set -ex; \
  ...
  bash -c "$(curl -q -LSsf "https://github.com/templatemgr/docker/raw/main/install.sh")"; \
  echo ""
...
LABEL \
  ...
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/docker" \
  ...
  org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/docker" \
