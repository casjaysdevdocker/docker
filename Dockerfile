...
LABEL org.opencontainers.image.url="https://docker.io/casjaysdevdocker/docker"
LABEL org.opencontainers.image.source="https://docker.io/casjaysdevdocker/docker"
