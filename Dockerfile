...
ARG IMAGE_REPO="casjaysdevdocker/docker"
...
ARG PACK_LIST="btrfs-progs e2fsprogs e2fsprogs-extra fuse-overlayfs git ip6tables iptables openssl pigz shadow-uidmap xfsprogs xz zfs docker docker-cli-buildx docker-cli-compose docker-registry nginx "
...
ENV HOSTNAME="casjaysdevdocker-docker"
...
LABEL org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/docker"
LABEL org.opencontainers.image.source="https://hub.docker.com/r/casjaysdevdocker/docker"
LABEL org.opencontainers.image.vcs-type="Git"
LABEL org.opencontainers.image.revision="${BUILD_VERSION}"
LABEL org.opencontainers.image.source="https://github.com/casjaysdevdocker/docker"
LABEL org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/docker"
