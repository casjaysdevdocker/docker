...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202210211813-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  start-docker.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Friday, Oct 21, 2022 18:13 EDT
# @@File             :  start-docker.sh
# @@Description      :  script to start docker
...
HOSTNAME="${HOSTNAME:-casjaysdev-docker}"
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Post copy commands
[ -e "/config/docker/daemon.json" ] || { mkdir -p "/config/docker" && touch "/config/docker/daemon.json"; }
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Initialized
