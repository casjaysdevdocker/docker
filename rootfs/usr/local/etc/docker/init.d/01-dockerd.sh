...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202410201135-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  WTFPL
# @@ReadME           :  01-docker.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Sunday, Oct 20, 2024 11:35 EDT
# @@File             :  01-docker.sh
# @@Description      :
...
__update_conf_files() {
	...
	[ -d "$HOME/.docker" ] && [ -d "/home/.docker" ] && [ "$HOME/.docker" != "/home/.docker" ] && cp -Rf "$HOME/.docker"* "/home/.docker"
	# allow custom functions
