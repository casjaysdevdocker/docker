...
VAR_DIR=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TMP_DIR="/tmp/docker-registry"       # set the temp dir
RUN_DIR="/run/docker-registry"       # set scripts pid dir
LOG_DIR="/data/logs/docker-registry" # set log directory
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set the working dir
WORK_DIR=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
[ -f "/config/env/docker-registry.script.sh" ] && . "/config/env/docker-registry.script.sh" # Generated by my dockermgr script
[ -f "/config/env/docker-registry.sh" ] && . "/config/env/docker-registry.sh"               # Overwrite the variabes
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__update_conf_files() {
  ...
  REGISTRY_HTTP_SECRET="${REGISTRY_HTTP_SECRET:-$REGISTRY_SECRET}" # set secret
  # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  # delete files
  #__rm ""
