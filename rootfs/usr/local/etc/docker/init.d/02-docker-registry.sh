...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202410201141-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  WTFPL
# @@ReadME           :  02-docker-registry.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Sunday, Oct 20, 2024 11:41 EDT
# @@File             :  02-docker-registry.sh
# @@Description      :
...
# set data directory
DATA_DIR="/data/docker-registry"
# set config directory
CONF_DIR="/config/docker-registry"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# set scripts pid dir
RUN_DIR="/run/docker-registry"
# set log directory
LOG_DIR="/data/logs/docker-registry"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set the working dir
WORK_DIR=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# command to execute
EXEC_CMD_BIN='docker-registry'
# command arguments
EXEC_CMD_ARGS='serve $CONF_DIR/config.yml'
...
# root user name
root_user_name="${DOCKER_REGISTRY_ROOT_USER_NAME:-}"
# root user password
root_user_pass="${DOCKER_REGISTRY_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
# normal user name
user_name="${DOCKER_REGISTRY_USER_NAME:-}"
# normal user password
user_pass="${DOCKER_REGISTRY_USER_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Load variables from config
# Generated by my dockermgr script
[ -f "/config/env/docker-registry.script.sh" ] && . "/config/env/docker-registry.script.sh"
# Overwrite the variabes
[ -f "/config/env/docker-registry.sh" ] && . "/config/env/docker-registry.sh"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Additional predefined variables
REGISTRY_SECRET="$(__random_password 32)"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
[ -f "$CONF_DIR/.secret" ] && REGISTRY_SECRET="$(<"$CONF_DIR/.secret")" || echo "$REGISTRY_SECRET" >"$CONF_DIR/.secret"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__update_conf_files() {
	...
	# set secret
	REGISTRY_HTTP_SECRET="${REGISTRY_HTTP_SECRET:-$REGISTRY_SECRET}"
	# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
	# delete files
	#__rm ""
