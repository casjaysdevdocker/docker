...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# set the temp dir
TMP_DIR="/tmp/docker-compose"
# set scripts pid dir
RUN_DIR="/run/docker-compose"
# set log directory
...
# root user name
root_user_name="${DOCKER_COMPOSE_ROOT_USER_NAME:-}"
# root user password
root_user_pass="${DOCKER_COMPOSE_ROOT_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Normal user info [password/random]
# normal user name
user_name="${DOCKER_COMPOSE_USER_NAME:-}"
# normal user password
user_pass="${DOCKER_COMPOSE_USER_PASS_WORD:-}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Load variables from config
# Generated by my dockermgr script
[ -f "/config/env/docker-compose.script.sh" ] && . "/config/env/docker-compose.script.sh"
# Overwrite the variabes
[ -f "/config/env/docker-compose.sh" ] && . "/config/env/docker-compose.sh"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
