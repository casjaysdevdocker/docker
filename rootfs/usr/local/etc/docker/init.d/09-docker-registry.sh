...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202408021831-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  WTFPL
# @@ReadME           :  09-docker-registry.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Friday, Aug 02, 2024 18:31 EDT
# @@File             :  09-docker-registry.sh
# @@Description      :
...
ETC_DIR="/etc/registry"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# set the var dir
VAR_DIR="/var/lib/registry"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
TMP_DIR="/tmp/registry"       # set the temp dir
RUN_DIR="/run/registry"       # set scripts pid dir
...
[ -f "/config/env/registry.script.sh" ] && . "/config/env/registry.script.sh" # Generated by my dockermgr script
[ -f "/config/env/registry.sh" ] && . "/config/env/registry.sh"               # Overwrite the variabes
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
[ -f "$CONF_DIR/.secret" ] && REGISTRY_HTTP_SECRET="$(<"$CONF_DIR/.secret")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__update_conf_files() {
  ...
  # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  # custom commands
  [ -f "$ETC_DIR/config.yml" ] && [ ! -f "$CONF_DIR/config.yml" ] && mv -f "$ETC_DIR/config.yml" ""$CONF_DIR/config.yml
